            ...
            <div class="content-grid">
                <div class="content-grid-info">
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <img src="<%# Eval("BLOGGORSEL") %>" alt="" style="width: 90%; height: 350px; position: relative; left: 30px; margin-bottom: 30px;" />
                            <h4><a href="BlogDetay.aspx?BLOGID=<%# Eval("BLOGID") %>" style="color: dodgerblue; font-size: 30px; margin-bottom: 60px; text-decoration-line: none; position: relative; left: 30px;"><%# Eval("BLOGBASLIK") %></a></h4>
                            <p style="margin: 30px;"><%# Eval("BLOGICERIK") %></p>
                        </ItemTemplate>
                    </asp:Repeater>
                    ...
                    <div class="content-form">
                        ...
                        <form runat="server">
                            ...
                            <asp:TextBox ID="TextBox2" runat="server" placeholder="Mailiniz" required=""></asp:TextBox>
                            <asp:TextBox ID="TextBox3" runat="server" placeholder="Yorumunuz" required="" Height="100px" TextMode="MultiLine"></asp:TextBox>
